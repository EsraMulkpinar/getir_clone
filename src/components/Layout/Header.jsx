...
const Header = () => {
  ...
  return (
    <div className="bg-brandColor ">
      <div className="container mx-auto max-w-[1220px] h-11 flex items-center justify-between">
        <a href="/">
          <img
            className="w-[35px] h-4 md:m-0 ml-5"
            alt="#"
        ...
        <nav className="md:flex hidden gap-x-8 text-sm">
          <button
            onClick={handleClick}
          ...
          >
            <LoginCard />
            <div>
              Kişisel verilerinize dair Aydınlatma Metni için tıklayınız.
            </div>
            <div className="">
              <div className="">Hala kayıt olmadınız mı? </div>
              <div className="">
